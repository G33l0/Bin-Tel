...
repository or opens a database for itself.
...
class AppContext:
    ...
    def __init__(
        ...
        log_event(logger, "Application context ready", version=APP_VERSION)
    ...
    def start_session(self, *, first_run: bool, startup_ms: float) -> None:
        """Do the light housekeeping a new session calls for."""
        try:
